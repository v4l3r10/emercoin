...
// namecoin commands below:
    ...
    { "name_delete",            &name_delete,            false,     false },
    { "sendtoname",             &sendtoname,             false,     false },
...
void StartRPCThreads()
{
    ...
    {
        strerr = strprintf((strerr.length() > 0 ? strerr + "\n" : "") +
            _("An error occurred while setting up the RPC port %u for listening on IPv4: %s"), endpoint.port(), e.what());
    }
