    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gongxincoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an Gongxincoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gongxincoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gongxincoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gongxincoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gongxincoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gongxincoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gongxincoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a gongxincoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gongxincoin Core help message to get a list with possible Gongxincoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gongxincoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Gongxincoin"); // default title
