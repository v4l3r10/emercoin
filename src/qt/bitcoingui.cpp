    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Emercoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/emercoin"));
    setWindowIcon(QIcon(":icons/emercoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/emercoin"), tr("&About Emercoin"), this);
    aboutAction->setStatusTip(tr("Show information about Emercoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Emercoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/emercoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/emercoin_testnet"));
            setWindowIcon(QIcon(":icons/emercoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/emercoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Emercoin address or malformed URI parameters."),
