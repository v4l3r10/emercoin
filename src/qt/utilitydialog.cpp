    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gongxincoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Gongxincoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gongxincoin Core is shutting down...") + "<br /><br />" +
