...
<context>
    ...
    <message>
        ...
        <translation>開啓 gongxincoin 協議的 URI 或付款要求</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>沒辦法啟動 gongxincoin 協議的按就付處理器</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Gongxincoin Alert" admin@foo.com
        ...
        <translation>要使用 gongxincoind, 或是對 gongxincoin-qt 指定 -server 選項，你必須要在以下設定檔中設定 RPC 密碼(選項: rpcpassword):
%s
建議你使用以下隨機產生的密碼:
rpcuser=gongxincoinrpc
rpcpassword=%s
...
比如說設定: alertnotify=echo %%s | mail -s "Gongxincoin Alert" admin@foo.com
</translation>
    </message>
    <message>
