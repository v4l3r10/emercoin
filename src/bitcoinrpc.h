...
extern void relockWalletAfterDuration(int64 seconds);
...
extern json_spirit::Value showkeypair(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value getnetworkghps(const json_spirit::Array& params, bool fHelp);
