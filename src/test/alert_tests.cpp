...
BOOST_AUTO_TEST_CASE(AlertApplies)
{
    ...
    // gongxincoin: TODO: sign alerts with gongxincoin key
...
//    }
    ...
    // Matches:
    // gongxincoin: for some bitcoin test alerts are read with nExpiration == 0, making following tests fail.
...
BOOST_AUTO_TEST_CASE(AlertNotify)
{
    ...
    // gongxincoin: following tests requires alertnotify.txt to exist, but for some reason this file is deleted at next instruction...
